			   ...
			   <div class="card-body">
			      <form method="POST" enctype="multipart/form-data">
			         ...
			         <div class="form-group">
			            ...
			            <input type="number" class="form-control" id="" name="price" placeholder="9.000.000">
			         ...
			         <div class="form-group row">
			         	<div class="col-sm-3">
				            ...
				            <input type="number" class="form-control" id="" name="sale" placeholder="10%">
			            ...
			            <div class="col-sm-3">
				            ...
				            <input type="number" class="form-control" id="" name="number" placeholder="100">
